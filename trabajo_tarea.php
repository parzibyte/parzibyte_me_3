<div id="detallesTarea">
    <div class="field">
        ...
        <div class="control">
            <input name="correoTarea" class="input" type="email" placeholder="<?php echo traducir("placeholder_correo_electronico"); ?>">
        </div>
    </div>
    <div class="field">
        <label class="label">
        ...
        <div class="control">
            <input name="confirmarCorreoTarea" class="input" type="email" placeholder="<?php echo traducir("placeholder_confirmar_correo_electronico"); ?>">
        </div>
    </div>
    <div class="field">
    ...
    <div class="field">
        <div class="control">
            <label class="checkbox">
                ...
                <?php echo traducir("trabajo_tarea_acepta_terminos") ?>
            </label>
        </div>
    </div>
</div>